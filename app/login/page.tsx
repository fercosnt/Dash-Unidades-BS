            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  required
                  autoComplete="email"
                  className="w-full rounded-lg border border-neutral-300 bg-white px-4 py-2.5 text-sm text-neutral-900 placeholder-neutral-400 transition-all focus:border-primary-600 focus:outline-none focus:ring-2 focus:ring-primary-500/20"
              ...
              <div>
                <label
                  htmlFor="password"
                  className="mb-1.5 flex items-center justify-between text-sm font-medium text-neutral-700"
                >
                  <span>Senha</span>
                </label>
                <input
              ...
              {error && (
                <div className="rounded-lg border border-danger/15 bg-danger-50 px-4 py-2.5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="mt-1 inline-flex w-full items-center justify-center rounded-lg bg-gradient-to-r from-primary-600 to-primary-700 px-4 py-2.5 text-sm font-heading font-semibold text-white shadow-md transition-all hover:shadow-lg hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-60"
              >
                {loading ? (
