  ...
  if (result.tipo === "orcamentos") {
    ...
    return (
      <div className="space-y-4">
        ...
        {fechados.length > 0 && (
          <div>
            <h4 className="font-medium text-slate-900 mb-2">Orçamentos fechados (APPROVED)</h4>
            <div className="overflow-x-auto rounded-lg border border-slate-200">
              <table className="min-w-full text-sm">
                <thead>
                  <tr className="bg-slate-50">
                    <th className="px-3 py-2 text-left font-medium text-slate-600">Paciente</th>
                    ...
                    <th className="px-3 py-2 text-left font-medium text-slate-600">Indicação</th>
                  </tr>
                </thead>
                <tbody>
                  {fechados.map((r, i) => (
        ...
        {abertos.length > 0 && (
          <div>
            <h4 className="font-medium text-slate-900 mb-2">Orçamentos abertos</h4>
            <div className="overflow-x-auto rounded-lg border border-slate-200">
              <table className="min-w-full text-sm">
                <thead>
                  <tr className="bg-slate-50">
      ...
      <div className="overflow-x-auto rounded-lg border border-slate-200">
        <table className="min-w-full text-sm">
          <thead>
            <tr className="bg-slate-50">
              <th className="px-3 py-2 text-left font-medium text-slate-600">Paciente</th>
              <th className="px-3 py-2 text-left font-medium text-slate-600">Procedimento</th>
              <th className="px-3 py-2 text-left font-medium text-slate-600">Data</th>
